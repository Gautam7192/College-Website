    ...
    allQuestions.forEach(function (question) {
        ...
        if (questionText.includes(searchTerm)) {
            ...
            suggestion.addEventListener('click', function () {
                ...
                displayModal(theQuestion, answer);
            });
    ...
    var faqData = {
        "about": [
            ...
            },
            {
                ...
                "answer": "Yes, GBU is recognized under UGC Section 12B and NAAC accredited     th B+ Grade."
            },
            {
